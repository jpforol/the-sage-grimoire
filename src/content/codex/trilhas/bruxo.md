...
summary: "Bruxos e bruxas verdadeiros pertencem à Alta Ordem Secreta da Bruxaria, uma instituição fundada antes das primeiras cidades pelos mais antigos praticantes de m…"
tags: ["especialista"]
source:
  book: "livro-basico"
  page: 191
...
**Fogo das Bruxa (Mágico):** Você pode usar uma ação para lançar chamas da ponta dos seus dedos. Escolha uma criatura ou objeto a até 10 metros de distância. Faça uma rolagem de Intelecto ou de Vontade contra a Agilidade do alvo. Em um sucesso, o alvo sofre 4d6 de dano. O dano aumenta para 6d6 no nível 6 e para 9d6 no nível 9. Em um sucesso crítico, o alvo também fica incendiado (sorte encerra).
